...
import * as AISecretAPI from './ai-secret';
import * as Shared from './shared';
import { AISecretsListObjects } from './shared';
import { type ListObjectsParams } from '../pagination';

export class AISecret extends APIResource {
  /**
...
export namespace AISecret {
  export import AISecretCreateParams = AISecretAPI.AISecretCreateParams;
  export import AISecretUpdateParams = AISecretAPI.AISecretUpdateParams;
  export import AISecretListParams = AISecretAPI.AISecretListParams;
  export import AISecretFindAndDeleteParams = AISecretAPI.AISecretFindAndDeleteParams;
  export import AISecretReplaceParams = AISecretAPI.AISecretReplaceParams;
}
