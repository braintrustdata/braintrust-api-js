...
import * as APIKeyAPI from '@braintrust/api/resources/api-key';
...
export namespace APIKeyResource {
  ...
  export import APIKeyCreateResponse = APIKeyAPI.APIKeyCreateResponse;
  export import APIKeysListObjects = APIKeyAPI.APIKeysListObjects;
  export import APIKeyCreateParams = APIKeyAPI.APIKeyCreateParams;
  export import APIKeyListParams = APIKeyAPI.APIKeyListParams;
}
