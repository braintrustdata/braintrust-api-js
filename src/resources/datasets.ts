...
import * as DatasetsAPI from '@braintrust/api/resources/datasets';
...
export namespace Datasets {
  ...
  export import DatasetFetchPostResponse = DatasetsAPI.DatasetFetchPostResponse;
  export import DatasetInsertResponse = DatasetsAPI.DatasetInsertResponse;
  export import DatasetSummarizeResponse = DatasetsAPI.DatasetSummarizeResponse;
  export import DatasetsListObjects = DatasetsAPI.DatasetsListObjects;
