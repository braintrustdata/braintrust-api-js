...
import * as ProjectScoreAPI from '@braintrust/api/resources/project-score';
import { ListObjects, type ListObjectsParams } from '@braintrust/api/pagination';

export class ProjectScoreResource extends APIResource {
  /**
...
export namespace ProjectScoreResource {
  export import ProjectScore = ProjectScoreAPI.ProjectScore;
  export import ProjectScoresListObjects = ProjectScoreAPI.ProjectScoresListObjects;
