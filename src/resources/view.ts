...
import * as ViewAPI from '@braintrust/api/resources/view';
import { ListObjects, type ListObjectsParams } from '@braintrust/api/pagination';

export class ViewResource extends APIResource {
  /**
...
export namespace ViewResource {
  export import View = ViewAPI.View;
  export import ViewsListObjects = ViewAPI.ViewsListObjects;
