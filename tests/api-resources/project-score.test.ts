...
describe('resource projectScore', () => {
  test('create: only required params', async () => {
    const responsePromise = client.projectScore.create({
      name: 'name',
  ...
  test('create: required and optional params', async () => {
    const response = await client.projectScore.create({
      name: 'name',
      project_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      score_type: 'slider',
      categories: [
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.projectScore.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
  ...
  test('update: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.projectScore.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
        path: '/_stainless_unknown_path',
      }),
    ).rejects.toThrow(Braintrust.NotFoundError);
  });
  ...
  test('list: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.projectScore.list({ path: '/_stainless_unknown_path' })).rejects.toThrow(
  ...
  test('delete: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.projectScore.delete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
        path: '/_stainless_unknown_path',
      }),
    ).rejects.toThrow(Braintrust.NotFoundError);
  });
  ...
  test('replace: only required params', async () => {
    const responsePromise = client.projectScore.replace({
      name: 'name',
      project_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      score_type: 'slider',
    });
  ...
  test('replace: required and optional params', async () => {
    const response = await client.projectScore.replace({
      name: 'name',
      project_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      score_type: 'slider',
      categories: [
