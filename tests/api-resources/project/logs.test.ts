...
describe('resource logs', () => {
  ...
  test('feedback: required and optional params', async () => {
    const response = await client.project.logs.feedback('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { feedback: [{ id: 'id', comment: 'comment', expected: {}, metadata: { foo: 'bar' }, scores: { foo: 0 }, source: 'app' }, { id: 'id', comment: 'comment', expected: {}, metadata: { foo: 'bar' }, scores: { foo: 0 }, source: 'app' }, { id: 'id', comment: 'comment', expected: {}, metadata: { foo: 'bar' }, scores: { foo: 0 }, source: 'app' }] });
  });
  ...
  test('insert: required and optional params', async () => {
    const response = await client.project.logs.insert('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { events: [{ id: 'id', _is_merge: true, _object_delete: true, _parent_id: '_parent_id', context: { caller_filename: 'caller_filename', caller_functionname: 'caller_functionname', caller_lineno: 0 }, created: '2019-12-27T18:11:19.117Z', error: {}, expected: {}, input: {}, metadata: { foo: 'bar' }, metrics: { completion_tokens: 0, end: 0, prompt_tokens: 0, start: 0, tokens: 0 }, output: {}, scores: { foo: 0 }, span_attributes: { name: 'name', type: 'llm' }, tags: ['string', 'string', 'string'] }, { id: 'id', _is_merge: true, _object_delete: true, _parent_id: '_parent_id', context: { caller_filename: 'caller_filename', caller_functionname: 'caller_functionname', caller_lineno: 0 }, created: '2019-12-27T18:11:19.117Z', error: {}, expected: {}, input: {}, metadata: { foo: 'bar' }, metrics: { completion_tokens: 0, end: 0, prompt_tokens: 0, start: 0, tokens: 0 }, output: {}, scores: { foo: 0 }, span_attributes: { name: 'name', type: 'llm' }, tags: ['string', 'string', 'string'] }, { id: 'id', _is_merge: true, _object_delete: true, _parent_id: '_parent_id', context: { caller_filename: 'caller_filename', caller_functionname: 'caller_functionname', caller_lineno: 0 }, created: '2019-12-27T18:11:19.117Z', error: {}, expected: {}, input: {}, metadata: { foo: 'bar' }, metrics: { completion_tokens: 0, end: 0, prompt_tokens: 0, start: 0, tokens: 0 }, output: {}, scores: { foo: 0 }, span_attributes: { name: 'name', type: 'llm' }, tags: ['string', 'string', 'string'] }] });
  });
});
